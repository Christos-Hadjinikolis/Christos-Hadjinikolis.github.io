...
\begin{entrylist}
    ...
    {Engineering Manager | ML Systems Lead}
    {
        ...
        \begin{itemize}[leftmargin=1.1em]
            ...
            \item \normalsize\textbf{Model Development \& MLOps:} Led 0-to-1 research-to-production delivery for destination/ETA sequence and transformer models in \textbf{PyTorch}; established MLflow, model/data versioning, automated evaluation gates, replay, monitoring, and model-serving workflows at \textbf{~6M} events/hour.
    ...
    {Academic Teaching and Technical Instruction}
    {
        {\small
        \setlength{\parindent}{0pt}
        \setlength{\leftskip}{0pt}
