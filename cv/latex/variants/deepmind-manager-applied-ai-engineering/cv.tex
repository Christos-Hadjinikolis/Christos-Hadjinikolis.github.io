...
\section{about me}
{\normalsize \textbf{ML Engineering Manager} with \textbf{16 years} across applied ML systems, data platforms, backend services, and AI research. I lead cross-functional teams that translate research-grade models and ambiguous product requirements into reliable, high-throughput production systems. Recent work spans \textbf{model-serving}, offline/online evaluation, streaming ML infrastructure, and reliability for high-volume prediction pipelines, backed by a Ph.D. in Computer Science and active AI standards work with ISO/CEN-CENELEC.}
...
\begin{entrylist}
    ...
    {Engineering Manager | ML Systems Lead}
    {
        ...
        \begin{itemize}[leftmargin=1.1em]
            ...
            \item \normalsize\textbf{Model Development \& MLOps:} Led \textbf{0-to-1} research-to-production delivery for destination and ETA/waiting-time sequence/transformer models in \textbf{PyTorch}; established \textbf{MLflow}, model/data versioning, automated evaluation gates, replay, monitoring, and model-serving workflows at \textbf{~6M events/hour}.
            \item \normalsize\textbf{Evaluation \& Iteration:} Built offline/online model-evaluation and replay loops; analysed edge cases and failure modes with domain experts and Product to drive metric-guided model, data, and interface improvements.
            ...
            \item \normalsize\textbf{Platform \& Standardisation:} Standardised I/O seams, data contracts, repo archetypes, AWS CodeArtifact publishing, ADRs, dev containers, and local E2E tests; cut a \textbf{3h DAG feedback loop to under 5 min}.
            \item \normalsize\textbf{Architecture \& Reliability:} Led \textbf{Kafka Streams-to-Flink} as a strategic platform move; maintained signal-quality controls, rollback/fallback paths, shared on-call, and \textbf{MTTR under 30 min}.
        \end{itemize}
    }
    \entry
    {04/2016--12/2020}
    ...
    {Senior Consultant | Data Scientist / ML Engineer}
    {
        ...
        \begin{itemize}[leftmargin=1.1em]
            \item \normalsize\textbf{Vodafone Group:} Led multi-workstream GCP data-science platform delivery; drove requirements, migration planning, CI/CD, workflow automation, ML lifecycle support, and feature-engineering migration.
            \item \normalsize\textbf{CNHi:} Lead Data Scientist/Scrum Master on predictive maintenance; translated stakeholder needs into DS/DE backlog and guided a \textbf{PySpark} team over live telemetry.
    ...
    {Academic Teaching \& Technical Instruction}
    {
        ...
        \setlength{\parindent}{0pt}
        \setlength{\leftskip}{0pt}
        Taught \textbf{algorithm design}, \textbf{data structures}, databases/\textbf{SQL}, and Java/Python during and after doctoral research; developed presentation discipline, learner support, and mentoring habits.
