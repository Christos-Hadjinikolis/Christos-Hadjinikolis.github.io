---
title: Just do it! 
title_html: "<span class='blog-title-accent blog-title-accent--signal'>Just do it!</span>"
author: Christos Hadjinikolis
layout: post
og_image: assets/images/posts/2020/just-do-it/2020-07-28-Just-do-it.jpeg
description: "A short reflection on why public writing matters, why criticism is not the point, and why you should publish before you feel ready."
seo_keywords: ["blogging", "public writing", "writing confidence", "learning in public", "engineering reflection"]
nav_tags: ["Writing", "Blogging", "Mindset"]
tldr_why_read: "A short, honest reminder that writing in public matters more than waiting to feel fully ready."
tldr_persona: "Engineers, builders, and first-time writers who keep delaying public writing until it feels safe."
tldr_learn: "Why blogging feels exposing, why that fear is normal, and why publishing imperfect work still has real value."
tldr_takeaways: ["Write before confidence arrives", "Criticism is part of the exchange", "Blogging is practice, not performance"]
---
The thing about writing a blog-post is that you are exposing yourself to the world; it feels a lot like <span class="blog-highlight blog-highlight--signal">flying for the first time</span>.

<span class="image center"><img src="{{ 'assets/images/posts/2020/just-do-it/2020-07-28-Just-do-it.jpeg' | relative_url }}" alt="Fly for the first time" /></span>
...
to do with being right neither it is about writing the perfect post. Put simply, it is just about <span class="blog-highlight blog-highlight--signal">doing it</span>.
