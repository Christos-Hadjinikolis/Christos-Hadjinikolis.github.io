...
tldr_takeaways: ["Ambiguous role labels create unicorn expectations and hide real staffing gaps", "T-shaped growth is valuable, but expecting full overlap across four disciplines is unrealistic", "The industry needs clearer taxonomy so teams can design interfaces instead of hiring fantasies"]
---
...
- someone who can also think about product, experimentation, and stakeholder communication

In other words, a unicorn.

I do not think this is just a wording problem.

I think it is a taxonomy problem, and it affects how teams hire, how careers grow, and how real systems get built.

<blockquote class="blog-pullquote">
  <p>When a field cannot describe its roles clearly, it starts hiring for fantasy and then wondering why delivery feels uneven.</p>
</blockquote>
...
That is where this stops being semantics.
...
To me, the centre of gravity of an <span class="blog-highlight blog-highlight--ml">ML Engineer</span> is not *"person who does some of all of the above."*
...
And when interfaces are vague, teams stop designing good collaboration boundaries and start relying on heroic overlap.
...
If we want better teams, better hiring, and more reliable delivery, we need clearer definitions of what these roles are actually for.

Because once the role language is vague enough, the organisation stops designing teams and starts collecting unicorn fantasies.
