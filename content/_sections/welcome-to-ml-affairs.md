...
icon: fa-compass
icon_image: assets/images/site/icons/welcome.svg
order: 5
---
<span class="image featured welcome-brand-mark logo-plate"><img src="{{ 'assets/images/site/ml-affairs-logo-welcome.png' | relative_url }}" alt="ML-Affairs logo with ninja engineer mascot" /></span>
...
<div class="prose-block">
  ...
  <p>More specifically, this site is where I write about:</p>

  <ul>
    <li>streaming-first ML systems</li>
    <li>the gap between experimentation and production</li>
    <li>event-driven architectures for inference and decision systems</li>
    <li>the trade-offs behind building reliable AI under messy real-world constraints</li>
  </ul>
